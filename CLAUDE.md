...
| **Lowcap Call Tracker** | ❌ Not used | 🟡 Optional | ❌ Not used | FINVIZ Elite CSV export when FINVIZ_API_KEY is set; otherwise the public screener HTML is parsed (page-limited) |
