...
**Total PnL:** +1.36% — equal weight across all 5 priced call(s)

**Generated:** 2026-09-24T15:21:22+00:00  
...
| Neutral | 3 |
| Hit rate % | 40.0 |
| **Total PnL % (equal weight, all calls)** | +1.36% |
| Average PnL % per call | 1.36 |
| Portfolio PnL % (equal weight, TAKE only) | — |

**Best call:** GRML (long, squeeze, unreviewed) +37.96% — entry 10.67 → 14.720000267028809
**Worst call:** NCPL (short, squeeze, shadow) -26.61% — entry 1.09 → 1.3801000118255615

### By instrument (call / put)

| Group | Calls | Open | Right | Wrong | Neutral | Hit rate % | Avg PnL % |
|---|---|---|---|---|---|---|---|
| call | 2 | 2 | 1 | 0 | 1 | 50.0 | 0.83 |
| put | 1 | 1 | 0 | 0 | 1 | 0.0 | -26.61 |

### By asset type

| Group | Calls | Open | Right | Wrong | Neutral | Hit rate % | Avg PnL % |
|---|---|---|---|---|---|---|---|
| stock | 5 | 5 | 2 | 0 | 3 | 40.0 | 1.36 |

### By screen variant

| Group | Calls | Open | Right | Wrong | Neutral | Hit rate % | Avg PnL % |
|---|---|---|---|---|---|---|---|
| squeeze | 5 | 5 | 2 | 0 | 3 | 40.0 | 1.36 |
...
|---|---|---|---|---|---|---|---|
| TAKE | 0 | 0 | 0 | 0 | 0 | — | — |
| SKIP (shadow) | 3 | 3 | 1 | 0 | 2 | 33.3 | -8.32 |
...
| technician | 6.0 | 4.0 | 2.0 | 0.652 | 3 | quality (higher is better) |
| skeptic | 9.0 | 7.25 | 1.75 | 0.164 | 3 | severity (lower is better) |
| risk_manager | 8.0 | 5.25 | 2.75 | 0.942 | 3 | quality (higher is better) |
...
| Group | Calls | Open | Right | Wrong | Neutral | Hit rate % | Avg PnL % |
|---|---|---|---|---|---|---|---|
| 0-40 | 1 | 1 | 0 | 0 | 1 | 0.0 | -26.61 |
| 40-70 | 2 | 2 | 1 | 0 | 1 | 50.0 | 0.83 |
| 70-100 | 0 | 0 | 0 | 0 | 0 | — | — |
...
|---|---|---|---|---|---|
| run_20260924T152058Z | 2026-09-24T15:20:58+00:00 | yes | — | — | — |
